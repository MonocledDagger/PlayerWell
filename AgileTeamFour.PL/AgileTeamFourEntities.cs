...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CommentID).HasName("PK__tblComme__C3B4DFAABBCD2D2A");
        ...
        {
            entity.HasKey(e => e.EventID).HasName("PK__tblEvent__7944C870CAC01C7A");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__tblFrien__3214EC278FAB7185");
        ...
        {
            entity.HasKey(e => e.GameID).HasName("PK__tblGames__2AB897DD9E68CB54");
        ...
        {
            entity.HasKey(e => e.GuildId).HasName("PK__tblGuild__3A3F896FA89E359F");
        ...
        {
            entity.HasKey(e => e.PlayerEventID).HasName("PK__tblPlaye__B001D167FB94B708");
        ...
        {
            entity.HasKey(e => e.PlayerGuildID).HasName("PK__tblPlaye__7A1E300668F9D0C4");
        ...
        {
            entity.HasKey(e => e.PostID).HasName("PK__tblPost__AA1260382271E934");
        ...
        {
            entity.HasKey(e => e.ReviewID).HasName("PK__tblRevie__74BC79AE16CD3D2E");
        ...
        {
            entity.HasKey(e => e.UserID).HasName("PK__tblUsers__1788CCACCF20DE7C");
